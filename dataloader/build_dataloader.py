...
def build_train_kitti360_loader(cfg):
    train_dataset_RoI = kitti_dataloader.KITTI360_Object_Dataset_Raw_RoI_Lidar(cfg)
    sampler_weights_RoI = np.loadtxt(cfg.TRAIN.WEIGHT_FILE)
...
def build_infer_kitti360_loader(cfg):
    infer_dataset = kitti_dataloader.KITTI360_Object_Dataset_BBox2D(cfg)
