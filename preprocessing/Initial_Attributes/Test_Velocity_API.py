...
def Get_Estimated_Velocity(multi_inputs,dynamic_mask_list,device="cuda:0"):
    ...
    estimated_velocity = Get_Estimated_Velocity_Using_CPI(multi_inputs=multi_inputs,dynamic_mask=None,device=device)
    for key in multi_inputs.keys():
