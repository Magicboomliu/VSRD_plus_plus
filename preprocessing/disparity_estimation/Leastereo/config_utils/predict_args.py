...
def obtain_predict_args():
    ...
    parser.add_argument('--crop_height', type=int, default=384,required=True, help="crop height")
    parser.add_argument('--crop_width', type=int, default=1416,required=True, help="crop width")
