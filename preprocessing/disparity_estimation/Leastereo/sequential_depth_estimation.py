...
from preprocessing.disparity_estimation.Leastereo.utils.colorize import get_color_map
from preprocessing.disparity_estimation.Leastereo.utils.multadds_count import count_parameters_in_MB, comp_multadds
...
def test_kitti(leftname, rightname):
