...
def clip_lines_to_front(lines, epsilon=1e-6):
    ...
    # points: [14,2,3]
    # points_1: [14,3], points_2: [14,3]
    points_1, points_2 = torch.unbind(lines, dim=-2)
    
    # from z aspect.    
    depths_1, depths_2 = points_1[..., -1:], points_2[..., -1:] #[14,1],[14,1]
    
    # make the one where z is bigger as the former dot
    # point1 > point2: shows the point1 is more ahead
    ...
    # there are not fixed 3D bounding box: the GT, Make it more fixed.
