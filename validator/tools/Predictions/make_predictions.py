...
from vsrd_plus_plus.datasets.transforms import Resizer,MaskAreaFilter,BoxGenerator,BoxSizeFilter,SoftRasterizer
from vsrd_plus_plus.transforms import MaskRefiner  # Use the one that accepts tensor directly

# VSRD Dataset
from vsrd_plus_plus.utils import collate_nested_dicts,Dict
# VSRD Networks
...
from vsrd_plus_plus.datasets.transforms import Resizer,MaskAreaFilter,BoxGenerator,BoxSizeFilter,SoftRasterizer
# MaskRefiner is imported from vsrd_plus_plus.transforms above (line 31)
...
def make_predictions(
    ...
    for instance_ids, grouped_image_filenames in tqdm(grouped_image_filenames.items()):
        ...
        if input_model_type == 'velocity_with_init':
            ...
            rectification_matrix = vsrd_plus_plus.operations.rotation_matrix_x(rectification_angle)
            ...
            mine_current_extrinsic_matrices =(
                ...
                vsrd_plus_plus.operations.expand_to_4x4(rectification_matrix.T))
            ...
            for source_image_filename in grouped_image_filenames:
                ...
                source_pd_boxes_2d = torch.stack([
                    vsrd_plus_plus.operations.project_box_3d(
        ...
        if input_model_type == "mlp_only":
            ...
            for source_image_filename in grouped_image_filenames:
                ...
                source_gt_masks = vsrd_plus_plus.transforms.MaskRefiner()(source_gt_masks)["masks"]
                source_gt_boxes_2d = torchvision.ops.masks_to_boxes(source_gt_masks.bool()).unflatten(-1, (2, 2))
