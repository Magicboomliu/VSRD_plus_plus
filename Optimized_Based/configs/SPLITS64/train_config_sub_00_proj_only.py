...
_C.TRAIN.DATASET.FILENAMES = ["/media/zliu/data12/dataset/VSRD_PP_Sync/filenames/R50-N16-M128-B16/2013_05_28_drive_0000_sync/sampled_image_filenames.txt"]
...
_C.TRAIN.LOGGING.SCALAR_INTERVALS=500
...
_C.TRAIN.CONFIG = "/home/zliu/TPAMI25/Tsubame/VSRD_plus_plus/Optimized_Based/configs/SPLITS64"


# Modifications Here
_C.TRAIN.MODEL_TYPE='Proj_Only'
_C.TRAIN.OPTIMIZATION_NUM_STEPS=3000
_C.TRAIN.OPTIMIZATION_WARMUP_STEPS=-1
_C.TRAIN.OPTIMIZATION_RESIDUAL_BOX_STEPS=1000

_C.TRAIN.USE_RDF_MODELING=False
_C.TRAIN.USE_DYNAMIC_MASK=False
_C.TRAIN.USE_DYNAMIC_MODELING=False

# Just for testing
_C.TRAIN.DYNAMIC_LABELS_PATH="/media/zliu/data12/dataset/VSRD_PP_Sync/est_dynamic_list/sync00/dynamic_mask.txt"
# selective from 'mlp', 'vector_velocity','scalar_velocity'
_C.TRAIN.DYNAMIC_MODELING_TYPE='none'
