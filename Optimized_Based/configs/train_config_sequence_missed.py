...
_C.TRAIN.DATASET.FILENAMES = ["/home/zliu/TPAMI25/KITTI360_Benchmarks/playground/missed_sample_filenameV2.txt"]
...
_C.TRAIN.CONFIG = "/home/zliu/TPAMI25/KITTI360_Benchmarks/Optimized_Based/configs"
...
# Just for testing
_C.TRAIN.DYNAMIC_LABELS_PATH="/home/zliu/TPAMI25/KITTI360_Benchmarks/playground/missed_dynamic_filenameV2.txt"

# selective from 'mlp', 'vector_velocity','scalar_velocity'
_C.TRAIN.DYNAMIC_MODELING_TYPE='vector_velocity'

_C.OUTPUT_ESTIMATED_VELOCITY_FOLDER="/media/zliu/data12/TPAMI_Results/Rest2/"