...
def parse_args():
    ...
    parser.add_argument(
        "--output_folder_name",
        type=str,
        default="/gs/bs/tga-lab_otm/zliu/VSRD_PP_Sync/train_tsubame_filenames_ablation",
        help="Path to pretrained model or model identifier from huggingface.co/models.")
...
if __name__=="__main__":
    ...
    filename_path = "/gs/bs/tga-lab_otm/zliu/VSRD_PP_Sync/train_tsubame_filenames_ablation/train_all_filenames_V1.txt"
    dynamic_list_path ="/gs/bs/tga-lab_otm/zliu/VSRD_PP_Sync/train_tsubame_filenames_ablation/train_all_dynamic_mask_V1.txt"
