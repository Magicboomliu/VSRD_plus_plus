...
def default_argument_parser():
    ...
    parser.add_argument("--split_type",default='vsrd_pp',type=str,help="Select from vsrd and vsrd_pp")
    parser.add_argument("--pretrained_model_path",default='none',type=str,help='pretrained model or continue learning')
    parser.add_argument("--code_path",default='none',type=str,help='pretrained model or continue learning')
...
def val_test_argument_parser():
    parser = argparse.ArgumentParser(description="Detectron2 Training")
    
    parser.add_argument("--evaluation_type",default='val',type=str,help="Select from vsrd and vsrd_pp")
    parser.add_argument("--pretrained_model_path",default='none',type=str,help='pretrained model or continue learning')
    parser.add_argument("--code_path",default='none',type=str,help='pretrained model or continue learning')
