...
import sys
sys.path.append("../..")
from vsrd_plus_plus.operations.geometric_operations import expand_to_4x4,rotation_matrix_x
...
class KITTI360Dataset(torch.utils.data.Dataset):
    ...
    Type:
    <class 'vsrd_plus_plus.transforms.geometric_transforms.Resizer'>
    target_transforms :
    ...
    Return:
    {'train': <vsrd_plus_plus.datasets.kitti_360_dataset.KITTI360Dataset object at 0x70b2fc35b1c0>}
