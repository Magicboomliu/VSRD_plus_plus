...
if __name__=='__main__':
    ...
    pd_dir_folder = "/media/zliu/data12/dataset/KITTI3D_VSRD_Vanilla/training/label_est/"
    gt_dir_folder = "/media/zliu/data12/dataset/KITTI3D_VSRD_Vanilla/training/label_2/"
