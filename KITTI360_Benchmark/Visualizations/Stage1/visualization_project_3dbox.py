...
def main(args):
    ...
    stage2_vis_output_folder_dynamic  = os.path.join(args.stage2_vis_output_folder,args.options,'dynamic')
    stage2_vis_output_folder_staic  = os.path.join(args.stage2_vis_output_folder,args.options,'static')
