...
from pipelines.refine_css_kitti360_version_1 import refine_css_kitti_360
...
def main():
    ...
    res = cfgparser.read(cfg) # this is only the configs path of the refine configs
    ...
    if args.train:
        ...
        print("directly inference using default settings and pre-trained models.")
        #refine_css_demo(cfgparser)  # Demo refinement
        refine_css_kitti_360()
