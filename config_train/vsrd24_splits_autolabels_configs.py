...
_C.INPUT.WIDTH_TRAIN = 1408
# Size of the smallest side of the image during testing
_C.INPUT.HEIGHT_TEST = 384
# Maximum size of the side of the image during testing
_C.INPUT.WIDTH_TEST = 1408
...
_C.SOLVER.MAX_EPOCHS = 35 # total steps in epochs
...
_C.SOLVER.DECAY_EPOCH_STEPS = [15, 20] # steps in epochs
...
_C.OUTPUT_DIR = "/data1/KITTI360/Z_Outputs_Models/VSRD24_Splits/Autolabels"

_C.SEED = -1
_C.CUDNN_BENCHMARK = True
_C.START_TIME = 0

_C.PATHS_CATALOG = os.path.join(os.path.dirname(__file__), "PATH_FOLDER/vsrd24_splits_autolabels_path.py")
_C.CODE_PATH=None
