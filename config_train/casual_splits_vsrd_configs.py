...
_C.OUTPUT_DIR = "/data1/KITTI360/Z_Outputs_Models/Casuals/VSRD"

_C.SEED = -1
_C.CUDNN_BENCHMARK = True
_C.START_TIME = 0

_C.PATHS_CATALOG = os.path.join(os.path.dirname(__file__), "PATH_FOLDER/casual_splits_vsrd_path.py")
