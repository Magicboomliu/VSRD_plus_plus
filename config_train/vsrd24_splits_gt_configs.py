...
_C.OUTPUT_DIR = "/data1/liu/PAMI_Datasets/Z_Outputs_Models/VSRD24_Splits/GT_Labels"

_C.SEED = -1
_C.CUDNN_BENCHMARK = True
_C.START_TIME = 0

_C.PATHS_CATALOG = os.path.join(os.path.dirname(__file__), "PATH_FOLDER/vsrd24_splits_gt_path.py")
